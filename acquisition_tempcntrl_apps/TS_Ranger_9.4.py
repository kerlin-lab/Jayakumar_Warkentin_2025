...
class TS_Ranger:
    ...
    def start_acquisition(self):
        ...
        self.abort_event.clear() # Reset abort event before starting
    ...
    def abort_acquisition(self):
        ...
        try:
            # Attempt to abort and close serial connection
            if serial_device and serial_device.is_open:
                #ch 1 voltage to 0
                serial_device.write(":w25=0000.\n".encode())
                #ch 2 voltage to 0
        ...
        try:
            ...
            print(f"Error releasing grabber: {e}")
            traceback.print_exc()

        # Set abort event and reset GUI elements
